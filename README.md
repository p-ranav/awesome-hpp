...
| [CImg](https://github.com/dtschump/CImg) | [![GitHub stars](https://img.shields.io/github/stars/dtschump/CImg?style=social)](https://github.com/dtschump/CImg/stargazers/) | CoolImage, single header only full featured image processing. | |
