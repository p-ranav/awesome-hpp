...
| [ppmpp](https://github.com/chbtoys/ppmpp) | [![GitHub stars](https://img.shields.io/github/stars/chbtoys/ppmpp?style=social)]([https://github.com/unclearness/nanopm/stargazers/](https://github.com/chbtoys/ppmpp/stargazers/)) | ppmpp, single header-only draw/read/write 2D graphics using only the standard library. | [![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](https://opensource.org/licenses/MIT) |
